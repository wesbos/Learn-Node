...
function ajaxHeart(e) {
  ...
  e.preventDefault();
  _axios2.default.post(this.action) // <---- is the url needed for the post action
  .then(function (resp) {
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 31.5562979;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -97.1318761;
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios.get('/api/search?q=' + this.value).then(function (resp) {
      if (resp.data.length) {
        searchResults.innerHTML = _dompurify2.default.sanitize(searchResultsHTML(resp.data));
        return;
        // console.log(html)
